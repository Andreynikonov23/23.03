...
public class Controller {
    ...
    static RadioElements selectedRadioItems;
    ...
    void initialize(){
        ...
        tableView.selectionModelProperty().addListener((obj, oldValue, newValue) -> {
            tableView.
            selectedRadioItems = tableView.getSelectionModel().getSelectedItem();
            System.out.println();
    ...
    public void actionDelete(ActionEvent event) {
        ...
        RadioElements result = dao.read(selectedIndex);
        dao.delete(result);
    }
}
